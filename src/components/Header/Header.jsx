...
<div className="top_header " data-aos="fade-down">
      ...
      <div className="bottom_header">
        ...
        <a href="https://github.com/Abdelmoniemhgagyy?tab=projects" target=' _blank '><i className="bi bi-github"></i></a>
         ...
         <a href="https://drive.google.com/file/d/1lXwarCAqaQcfEs0oo_taIrZMAg7VtFu4/view" target=' _blank '><i className="bi bi-eye-fill"></i> </a>
         <a href="https://docs.google.com/uc?export=download&id=1lXwarCAqaQcfEs0oo_taIrZMAg7VtFu4" target=' _blank '> <i className="bi bi-download" ></i></a>
