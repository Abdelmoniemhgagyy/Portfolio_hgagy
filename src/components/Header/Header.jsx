...
<div className="top_header " data-aos="fade-down">
      ...
      <div className="bottom_header">
        ...
        <a href="https://github.com/Abdelmoniemhgagyy?tab=projects" target=' _blank '><i className="bi bi-github"></i></a>
         ...
         <a href="https://drive.google.com/file/d/16TUXcVl1V0-LslDTt5PCoFSgBtapP0LG/view" target=' _blank '><i className="bi bi-eye-fill"></i> </a>
         <a href="https://docs.google.com/uc?export=download&id=16TUXcVl1V0-LslDTt5PCoFSgBtapP0LG" target=' _blank '> <i className="bi bi-download" ></i></a>
